...
const translations: ProductTranslations = {
  ...
  ko: {
    'torr-rf': {
      ...
      keyTechnologies: [
        {
          name: '자동 원형 모션 헤드(특허 제10-2507843호)',
      ...
      regulatoryNotice: [
        ...
        '식품의약품안전처 의료기기 허가번호: 제22-156호',
      ],
    },
    'ulblanc': {
      // 허가 사용목적 원문 미확보 — 효능 단정 금지, 전 항목 '~하도록 설계' 서술 유지.
      // 질환명(여드름 등) 언급은 허가증 사용목적 원문 확인 전까지 금지.
      tagline: '멀티 주파수 초음파 워크스테이션',
      overview: 'ULBLANC은 듀얼 주파수 초음파 타이트닝과 음향 캐비테이션 기반 유효 성분 경피 전달을 결합한 멀티 모드 스킨케어 워크스테이션입니다.',
      description: '피부 표면을 보존하는 비침습 방식으로 시술하도록 설계되었으며, 표피와 심부 조직을 함께 케어하도록 고안된 다이내믹 듀얼 웨이브 기술을 탑재했습니다.',
      keyTechnologies: [
        {
          name: 'Sono-I(다이내믹 듀얼 웨이브™)',
          description: '서로 다른 초음파 주파수를 교차 적용하여 표피와 진피를 함께 타깃하도록 설계되었습니다. 1/3 MHz는 진피 깊은 층 타이트닝을 위해, 3/10 MHz는 표피 진정을 위해 구성되었습니다.',
        },
        {
          name: 'i-Booster(소노포레시스)',
          description: '28kHz 초음파로 음향 캐비테이션(마이크로젯 효과)을 발생시켜, 유효 성분의 심부 경피 전달을 위한 미세 통로를 형성하도록 설계되었습니다.',
        },
      ],
      indications: [
        '피부 탄력 및 타이트닝 시술을 위해 설계되었습니다',
        '주름 부위 케어 시술을 위해 설계되었습니다',
        '유효 성분의 경피 전달을 돕도록 설계되었습니다(소노포레시스)',
        '민감한 피부에도 부드럽게 적용되는 피부 진정 시술을 위해 설계되었습니다',
      ],
      specLabels: {
      ...
      regulatoryNotice: [
        '이 제품은 "의료기기"이며, "사용상의 주의사항"과 "사용방법"을 잘 읽고 사용하십시오.',
        '식품의약품안전처 의료기기 인증번호: 제21-4685호',
      ],
    },
    'newchae-shot': {
      // 공산품(가정용 미용기기, KC/CE/VCCI) — 의료기기 아님.
      // 의료기기법 제26조제7항: 의료기기 오인 표현(의료 기술/클리닉 수준/콜라겐 재생/진피 가열 등) 금지.
      // 인체적용시험 수치(128.48% 등)는 시험보고서 실물(기관·기간·표본수) 확보 전까지 복원 금지.
      tagline: '3-in-1 퍼스널 뷰티 디바이스',
      overview: 'NEWCHAE SHOT은 멀티채널 에너지 전달 기술을 컴팩트한 디자인에 담은 가정용 미용기기입니다.',
      description: 'RF, EMS, ELP(일렉트로포레이션) 3가지 모드를 하나의 기기에 결합하여 가정에서 간편하게 홈케어할 수 있도록 설계되었습니다. 본 제품은 의료기기가 아닌 가정용 미용기기(공산품)입니다.',
      keyTechnologies: [
        {
          name: 'RF 모드(온열 케어)',
          description: '1MHz 멀티채널 RF 스택 기술로 피부에 따뜻한 온열감을 전달하도록 설계되었습니다. (최대 출력 8W)',
        },
        {
          name: 'EMS 모드(페이스 라인 케어)',
          description: '1KHz의 부드러운 전기 자극(EMS)을 활용한 페이스 라인 홈케어 모드입니다.',
        },
        {
          name: 'ELP 모드(스킨 부스트)',
      ...
      clinicalBenefits: [
        'RF·EMS·일렉트로포레이션 3가지 모드로 피부 결·탄력·광채 케어를 돕도록 설계',
        '1회 10분 사용, 2분 30초마다 구간 완료 알림',
        '의료용 등급 스테인리스 전극(도금 아님) / 삼성SDI 셀, USB-C 충전(1회 충전 시 5~6회 사용)',
        '국내 GMP 인증 기업에서 제조, KC·CE·VCCI 인증',
      ],
      // 영어 원본 6개 인덱스와 1:1 정렬 필수 — 일부만 번역하면 [id].astro 인덱스 매핑으로 영어 효능 문구가 폴백 노출됨.
      differentiators: [
        {
          feature: 'RF 기술 헤리티지',
          description: '의료기기 TORR RF를 개발한 자사 제조 기술력을 바탕으로 설계되었습니다 (본 제품은 의료기기가 아닌 가정용 미용기기입니다)',
        },
        {
          feature: '오토샷 시스템',
          description: 'RF 에너지 출력을 일정 간격으로 집중 전달하며, 구역별 완료를 부저로 알려줍니다',
        },
        {
          feature: '소재와 배터리',
          description: '의료용 등급 스테인리스 전극(도금 아님), 삼성SDI 3,350mAh 리튬이온 배터리 적용',
        },
        {
          feature: 'RF 사양',
          description: '1MHz, 최대 8W, RF STACK 방식으로 에너지를 전달하도록 설계되었습니다',
        },
        {
          feature: '스마트 진동',
          description: '분당 10,000회 미세 진동, 모드별 진동 패턴 적용',
        },
        {
          feature: '제조·인증',
          description: '국내 GMP 인증 기업에서 제조, KC·CE·VCCI 인증 획득',
        },
      ],
      regulatoryNotice: [
        'NEWCHAE SHOT은 의료기기가 아닌 가정용 미용기기(공산품)입니다.',
        '본 제품은 질병의 진단·치료·예방을 목적으로 하는 의료기기가 아닙니다.',
        'KC(한국)·CE(유럽)·VCCI(일본) 인증 제품입니다.',
      ],
    },
    'lumino-wave': {
      ...
      keyTechnologies: [
        {
          name: '초음파 + 레이저 융복합',
          description: '초음파 진동과 레이저 조사가 동시에 이루어지는 융복합 방식입니다. 초음파 효과로 빛의 산란을 줄여 레이저가 더 깊은 층까지 도달하도록 하는 원리를 적용해 개발하고 있습니다.',
        },
      ],
      clinicalBenefits: [
        '더 낮은 출력/에너지 활용을 목표로 한 융복합 설계',
        '피부 자극 부담을 줄이는 것을 목표로 한 설계',
        '진피층까지 레이저 전달력을 높이는 것을 목표로 한 설계',
        'MFDS(식약처) 허가 심사 진행 중 (2026년 하반기 출시 목표)',
      ],
      regulatoryNotice: [
        'LUMINO WAVE는 현재 식품의약품안전처 허가·인증 절차가 진행 중인 개발 단계 제품으로, 아직 국내 허가·인증을 받지 않았습니다.',
        '본 페이지는 개발 현황 안내 목적이며, 제품의 효능·효과 및 안전성은 허가 완료 후 허가사항에 따릅니다.',
      ],
    },
  },

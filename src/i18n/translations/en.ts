...
export const en = {
  ...
  products: {
    ...
    details: {
      ...
      handpieceConfig: 'Handpiece Configuration',
      benefits: 'Benefits',
      tipSize: 'Tip Size',
      depth: 'Depth',
      ...
      medicalCosmetic: 'Medical Cosmetic',
      model: 'Model',
      requestQuote: 'Request Quote',
      requestDemo: 'Request Demo',
      interestedIn: 'Interested in this product?',
      contactCta: 'Contact our sales team for pricing, demo scheduling, or technical questions.',
  ...
  about: {
    ...
    hero: {
      label: 'About BRITZMEDI',
      title1: 'Pioneering Aesthetic',
      title2: 'Medical Innovation',
    },
    overview: {
    ...
    philosophy: {
      ...
      text: 'Beyond developing aesthetic devices, we are committed to researching sustainable beauty for everyday life.',
    },
    ip: {
      title: 'Intellectual Property',
      registeredPatents: 'Registered Patents',
      trademarks: 'Trademarks',
      domesticPatents: 'Domestic Patents',
      internationalPatents: 'International Patents',
    },
    history: {
      label: 'Our Journey',
      title: 'Company History & Milestones',
      subtitle: 'From a specialized R&D institute to a global medical device manufacturer with FDA clearance.',
    },
    milestones: {
      '2017': {
    ...
    rnd: {
      ...
      subtitle: 'BRITZMEDI operates as a technology-intensive company with a strong focus on intellectual property to secure competitive advantages in the aesthetic medical field.',
      points: {
        research: 'Company-affiliated Research Institute certified since 2017',
        venture: 'Venture Enterprise certification (R&D Type) valid until June 2028',
        patents: 'In-house development of patented convergence technologies',
        inventors: 'Core inventors leading key patent applications for advanced technologies',
      },
    },
    tech: {
  ...
  contact: {
    ...
    hero: {
      ...
      title2: 'Conversation',
      description: "Whether you're interested in our products, exploring partnership opportunities, or need technical support, our team is here to help.",
    },
    ...
    referral: {
      ...
      tradeShow: 'Industry Event / Trade Show',
      referral: 'Referral',
      socialMedia: 'Social Media',
      articleBlog: 'Online Article / Blog',
    ...
    validation: {
      ...
      companyNameMin: 'Company name is required (min 2 characters).',
      yourNameMin: 'Your name is required (min 2 characters).',
      jobTitleRequired: 'Job title is required.',
      countryRequired: 'Please select your country.',
      invalidEmail: 'Please enter a valid email address.',
      businessEmailRequired: 'Please use your business email address. Personal emails (Gmail, Yahoo, etc.) are not accepted.',
      tempEmailNotAccepted: 'Temporary email addresses are not accepted.',
    ...
    success: {
      ...
      message: "Thank you for your inquiry. We'll get back to you within 1-2 business days.",
    },
    error: {
  ...
  // Footer
  footer: {
    description: 'Leading innovation in aesthetic medicine with FDA-cleared technology from Korea.',
    products: 'Products',
    company: 'Company',
    resources: 'Resources',
    contact: 'Contact',

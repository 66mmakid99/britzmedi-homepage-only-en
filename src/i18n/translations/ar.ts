...
export const ar: TranslationKeys = {
  ...
  products: {
    ...
    details: {
      ...
      technology: 'التقنية',
      clinicalUse: 'الاستخدام السريري',
      technicalData: 'البيانات التقنية',
      accessories: 'الملحقات',
      handpieceConfig: 'تكوين القبضة اليدوية',
      benefits: 'المزايا',
      tipSize: 'حجم الرأس',
      depth: 'العمق',
      ...
      medicalCosmetic: 'تجميل طبي',
      model: 'الموديل',
      requestQuote: 'طلب عرض سعر',
      requestDemo: 'طلب عرض توضيحي',
      interestedIn: 'مهتم بهذا المنتج؟',
      contactCta: 'اتصل بفريق المبيعات لدينا للحصول على الأسعار أو جدولة العروض التوضيحية أو الأسئلة التقنية.',
  ...
  contact: {
    ...
    referral: {
      ...
      tradeShow: 'حدث صناعي / معرض تجاري',
      referral: 'توصية',
      socialMedia: 'وسائل التواصل الاجتماعي',
      articleBlog: 'مقال عبر الإنترنت / مدونة',
    ...
    error: {
      ...
      generic: 'يرجى المحاولة مرة أخرى لاحقاً أو الاتصال بنا مباشرة عبر البريد الإلكتروني sh.lee@britzmedi.com',
    },
    info: {
  ...
  faq: {
    ...
    items: {
      ...
      'technical-support': {
        ...
        answer: 'الدعم الفني متاح من خلال قنوات متعددة: 1) اتصل بموزعك المعتمد المحلي، 2) أرسل بريداً إلكترونياً إلى فريق الدعم لدينا على sh.lee@britzmedi.com، 3) اتصل بنا على +82-70-4348-7244 (WhatsApp: +82 10-6525-9442) خلال ساعات العمل (9:00 صباحاً - 6:00 مساءً بتوقيت كوريا، من الاثنين إلى الجمعة). نهدف للرد على جميع الاستفسارات خلال 1-2 يوم عمل.',
      },
      'iso-certification': {
  ...
  footer: {
    ...
    newsletter: {
      title: 'ابقَ على اطلاع مع BRITZMEDI',
      subtitle: 'احصل على أحدث أخبار المنتجات ورؤى الصناعة.',
      placeholder: 'عنوان البريد الإلكتروني',
      subscribe: 'اشترك',
      privacy: 'نحن نحترم خصوصيتك. يمكنك إلغاء الاشتراك في أي وقت.',
      msgInvalid: 'الرجاء إدخال عنوان بريد إلكتروني صالح.',
      msgSubscribing: 'جار الاشتراك...',
      msgSuccess: 'شكراً لاشتراكك!',
      msgError: 'حدث خطأ ما. يرجى المحاولة مرة أخرى.',
      msgNetwork: 'خطأ في الشبكة. يرجى المحاولة مرة أخرى.',
    },
  },

  ...
  faq: {
    ...
    items: {
      ...
      'technical-support': {
        ...
        answer: 'الدعم الفني متاح من خلال قنوات متعددة: 1) اتصل بموزعك المعتمد المحلي، 2) أرسل بريداً إلكترونياً إلى فريق الدعم لدينا على sh.lee@britzmedi.com، 3) اتصل بنا على +82-70-4348-7244 خلال ساعات العمل (9:00 صباحاً - 6:00 مساءً بتوقيت كوريا، من الاثنين إلى الجمعة). نهدف للرد على جميع الاستفسارات خلال 1-2 يوم عمل.',
      },
      'iso-certification': {

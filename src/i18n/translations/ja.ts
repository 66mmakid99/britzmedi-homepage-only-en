  ...
  faq: {
    ...
    items: {
      ...
      'technical-support': {
        ...
        answer: 'テクニカルサポートは複数のチャネルで提供されています：1）地域の公認販売代理店にご連絡、2）sh.lee@britzmedi.comにメールでサポートチームに問い合わせ、3）営業時間内（月〜金曜日の午前9時〜午後6時KST）に+82-70-4348-7244 (WhatsApp: +82 10-6525-9442)に電話。すべてのお問い合わせに1-2営業日以内に回答することを目指しています。',
      },
      'iso-certification': {
